            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Create Ojol Form --}}
                        <form action="{{ route('ojol.store') }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="extra_price" id="extra_price" class="form-control" oninput="changeValue(this)" value="{{ @old('extra_price') }}">
                                            @error('extra_price')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" max="100" name="percent" id="percent" class="form-control" value="{{ @old('percent') }}">
                                        @error('percent')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
