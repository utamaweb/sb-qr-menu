...
class ExpenseController extends Controller
{
    public function category() {
        $expense_category = ExpenseCategory::where('business_id', auth()->user()->warehouse->business_id)->get();
    ...
    public function getExpense() {
        ...
        $expenses['data'] = Expense::with('warehouse', 'expenseCategory', 'user')->where('shift_id', $shift->id)->get()->map(function ($item){
            $filteredData = [
                'id'                  => $item->id,
    ...
    public function show($id) {
        $expense = Expense::with('expenseCategory')->where('id', $id)->first();
