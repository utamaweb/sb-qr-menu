      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="form-group col-12">
                <label>Tanggal *</label>
                <input type="date" placeholder="Tanggal pendaftaran..." name="date" required="required" class="form-control">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-6">
                <label>Nama Outlet *</label>
                <input type="text" placeholder="Nama outlet..." name="name" required="required" class="form-control">
            </div>
            <div class="form-group col-6">
                <label>Nomor Outlet *</label>
                <input type="number" placeholder="Nomor owner..." name="phone-outlet" required="required" class="form-control">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-6">
                <label>Email Outlet *</label>
                <input type="email" placeholder="Email outlet..." name="email-outlet" required="required" class="form-control">
            </div>
            <div class="form-group col-6">
                <label>Website Outlet *</label>
                <input type="text" placeholder="Website owner..." name="website-outlet" required="required" class="form-control">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-6">
                <label>Alamat Outlet *</label>
                <input type="text" placeholder="Alamat outlet..." name="alamat-outlet" required="required" class="form-control">
            </div>
            <div class="form-group col-6">
                <label>Logo Outlet *</label>
                <input type="file" placeholder="Logo outlet..." name="logo-outlet" required="required" class="form-control">
            </div>
        </div>
        <h3 class="mt-4">DATA OWNER</h3>
        <hr>
        <div class="row">
            <div class="form-group col-6">
                <label>Nama Owner *</label>
                <input type="text" placeholder="Nama owner..." name="name-owner" required="required" class="form-control">
            </div>
            <div class="form-group col-6">
                <label>Nomor Owner *</label>
                <input type="number" placeholder="Nomor owner..." name="phone-owner" required="required" class="form-control">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-6">
                <label>Email Owner *</label>
                <input type="email" placeholder="Email owner..." name="email-owner" required="required" class="form-control">
            </div>
            <div class="form-group col-6">
                <label>Alamat Owner *</label>
                <input type="text" placeholder="Alamat owner..." name="phone-owner" required="required" class="form-control">
            </div>
        </div>
        <h3 class="mt-4">DATA LOGIN</h3>
        <hr>
        <div class="row">
