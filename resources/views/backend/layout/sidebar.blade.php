<ul id="side-main-menu" class="side-menu list-unstyled">
    ...
    <li id="dashboard"><a href="{{ route('admin.dashboard') }}"> <i class="dripicons-meter"></i><span>Beranda</span></a>
    </li>
    {{-- menu --}}
    {{-- Menu Superadmin --}}
    @if (auth()->user()->hasRole('Superadmin'))
        <li id="role"><a href="{{ route('role.index') }}"> <i class="dripicons-user-group"></i><span>Role</span></a>
        </li>
        <li id="user"><a href="{{ route('user.index') }}"> <i class="dripicons-user"></i><span>User</span></a></li>
        <li id="bisnis"><a href="{{ route('business.index') }}"> <i
                    class="dripicons-user-id"></i><span>Bisnis</span></a></li>
        <li id="outlet"><a href="{{ route('outlet.index') }}"> <i class="dripicons-store"></i><span>Outlet</span></a>
        </li>
        <li id="unit"><a href="{{ route('unit.index') }}"> <i class="dripicons-user-id"></i><span>Unit</span></a>
        </li>
    ...
    @elseif(auth()->user()->hasRole('Admin Bisnis'))
        <li id="ojol"><a href="{{ route('ojol.index') }}"> <i class="dripicons-location"></i><span>Ojek
                    Online</span></a></li>
        ...
        <li id="outlet"><a href="{{ route('outlet.index') }}"> <i
                    class="dripicons-store"></i><span>Outlet</span></a></li>
        <li>
        ...
        <li>
            ...
            <ul id="report" class="collapse list-unstyled " style="border-radius: 10px;">
                <li id="laporan-transaksi-produk"><a href="{{ route('report.differenceStockReport') }}?warehouse_id=all">Laporan Selisih Stok</a>
                </li>
    ...
    @elseif(auth()->user()->hasRole('Admin Outlet'))
        ...
        <li id="produk-outlet"><a href="{{ route('produk-outlet.index') }}"> <i
                    class="dripicons-user-id"></i><span>Produk Outlet</span></a></li>
        <li id="daftar-stok"><a href="{{ route('stok.index') }}"> <i class="dripicons-user-id"></i><span>Daftar
                    Stok</span></a></li>
        <li id="tambah-stok"><a href="{{ route('pembelian-stok.index') }}"> <i
                    class="dripicons-user-id"></i><span>Tambah Stok</span></a></li>
        <li id="stock-opname"><a href="{{ route('stock-opname.index') }}"> <i
                    class="dripicons-view-thumb"></i><span>Stok Opname</span></a></li>
        <li id="list-transaction"><a href="{{ route('report.listTransaction') }}"> <i
                    class="dripicons-document-remove"></i><span>List Transaksi</span></a></li>
        <li>
            <a href="#report" aria-expanded="false" data-toggle="collapse"> <i
                    class="dripicons-document-remove"></i><span>Laporan</span></a>
            <ul id="report" class="collapse list-unstyled " style="border-radius: 10px;">
        ...
        <li>
            <a href="#expense" aria-expanded="false" data-toggle="collapse"> <i
                    class="dripicons-wallet"></i><span>Biaya Pengeluaran</span></a>
            <ul id="expense" class="collapse list-unstyled " style="border-radius: 10px;">
                <li id="exp-list-menu"><a href="{{ route('pengeluaran.index') }}">Daftar Pengeluaran</a></li>
            </ul>
        </li>
