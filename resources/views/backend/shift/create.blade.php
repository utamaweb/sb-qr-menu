...
<section>
    ...
    @endif
        ...
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info"><i class="dripicons-plus"></i> Tambah Shift</a>&nbsp;
    </div>
        ...
        <table id="ingredient-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$shift->id}}">
                    ...
                    <td>{{ $shift->warehouse->name }}</td>
                    <td>{{ $shift->initial_shift_money }}</td>
                    <td>
                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#editModal-{{$shift->id}}"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button>
                        {{-- Edit Modal --}}
                        <div id="editModal-{{$shift->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                ...
                                <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                                    <form action="{{route('shift.update', $shift->id)}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$shift->shift_name}}" name="shift_name" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Jam Shift *</label>
                                            <input type="text" value="{{$shift->shift_hour}}" name="shift_hour" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Cabang *</label>
                                            <select name="warehouse_id" id="" class="form-control">
                                                ...
                                                <option value="{{$warehouse->id}}" {{$shift->warehouse_id == $warehouse->id ? 'selected' : ''}}>{{$warehouse->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Modal Awal Shift *</label>
                                            <input type="text" value="{{$shift->initial_shift_money}}" name="initial_shift_money" required class="form-control">
                                        </div>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">Tambah Shift</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label>Jam Shift *</label>
                        <input type="text" name="shift_hour" required class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Cabang *</label>
                        <select name="warehouse_id" id="" class="form-control">
                    ...
                    <div class="form-group">
                        <label>Modal Awal Shift *</label>
                        <input type="text" name="initial_shift_money" required class="form-control">
                    </div>
                    <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
            </form>
        </div>
...
<div id="importUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'shift.import', 'method' => 'post', 'files' => true]) !!}
        <div class="modal-header">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="sample_file/shift.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
            </div>
            <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
