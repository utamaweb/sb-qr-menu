...
<section>
    <div class="container-fluid">
        ...
        @endif
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info add-warehouse-btn"><i
                class="dripicons-plus"></i> Tambah Outlet</a>
    ...
    <div class="table-responsive">
        <table id="warehouse-table" class="table" style="width: 100%;">
            <thead>
                <tr>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" placeholder="Nama outlet..." name="name" required="required"
                            class="form-control">
                    </div>
                    <div class="form-group col-6">
                        <label>Alamat *</label>
                        <input type="text" placeholder="Alamat outlet..." name="phone-outlet" required="required"
                            class="form-control">
                    </div>
