...
<section>
    ...
    @endif
        ...
        @if(in_array("products-add", $all_permission))
            <a href="{{route('products.create')}}" class="btn btn-info add-product-btn"><i class="dripicons-plus"></i>Tambah Produk</a>
        @endif
    </div>
        ...
        if(product[18]) {
            ...
            if(product_image.length > 1) {
                ...
                for (var i = 0; i < product_image.length; i++) {
                    if(!i)
                        slidertext += '<div class="carousel-item active"><img src="storage/images/product/'+product_image[i]+'" height="300" width="100%"></div>';
                    else
                        slidertext += '<div class="carousel-item"><img src="storage/images/product/'+product_image[i]+'" height="300" width="100%"></div>';
                }
                ...
                slidertext = '<img src="storage/images/product/'+product[18]+'" height="300" width="100%">';
            }
        }
        else {
