                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            {{ Form::open(['route' => ['ojol-warehouse.destroy', $ojol->id], 'method' => 'DELETE']) }}
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Kembali Ke Nilai Awal?')"></i> Kembali Ke Nilai Awal</button>
                            {{ Form::close() }}
                        </div>
                    </div>
                        ...
                        <form action="{{ route('ojol-warehouse.store', $ojol->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 d-flex justify-content-end pt-3">
                                    <div class="form-group">
                                        <a href="{{ route('ojol-warehouse.index') }}" class="btn btn-outline-primary mr-2">Kembali</a>
                                    </div>
                                    <div class="form-group">
